...
class SteeringPID:
    ...
    def __init__(self):
        ...
        self.desired_angle_sub = rospy.Subscriber("/control/desired_angle", Float64, self.desired_angle_callback)
        ...
        # this should be changed from a topic for future tasks: desired_angle
    ...
    def desired_angle_callback(self, a):
        DATA = a.data
        self.desired_angle = a.data
        rospy.loginfo("Desired Angle at [DATA]")

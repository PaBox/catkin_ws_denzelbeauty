...
#    #Parking in
#    rospy.sleep(4)
#    driving_direction_pub1.publish(0.205)

#    rospy.sleep(6)
#    driving_direction_pub2.publish(0.22)
...
#    rospy.sleep(6)
#    pub_forward.publish(0.905)

    rospy.sleep(4)
    driving_direction_pub1.publish(0.18)

    rospy.sleep(6)
    driving_direction_pub2.publish(3.2)
